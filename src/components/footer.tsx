    ...
    <footer className="relative z-10 border-t border-white/10 bg-black/50 backdrop-blur-sm">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* Center: Open Source Badge & Version */}
          <div className="flex items-center gap-3">
            ...
            <Link
              href="https://github.com/Lampung-Dev/lampung-dev-web/blob/main/CHANGELOG.md"
              target="_blank"
              rel="noopener noreferrer"
              title="View Changelog"
              className="flex items-center px-3 py-1.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300 text-xs font-mono text-gray-400 hover:text-white"
            >
